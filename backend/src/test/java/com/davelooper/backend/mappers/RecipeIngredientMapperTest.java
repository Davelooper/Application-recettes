...
class RecipeIngredientMapperTest {
  ...
  void shouldMapEntityToResponse() {
    ...
    Ingredient ingredient =
        Ingredient.builder().id(2L).name("Farine").seasonalities(new HashSet<>()).build();
  ...
  void shouldHandleNullUnit() {
    ...
    RecipeIngredient entity = RecipeIngredient.builder().ingredient(ingredient).unit(null).build();
