...
/**
 * DTO pour la mise à jour d'une recette existante. Les champs sont optionnels pour permettre des
 * mises à jour partielles (PATCH style).
 */
public record RecipeUpdateRequestDTO(
  ...
  public record RecipeIngredientUpdateRequestDTO(
      Long ingredientId, BigDecimal quantity, Long unitId) {}

  /** DTO interne pour la mise à jour d'étapes. */
  public record RecipeStepUpdateRequestDTO(Integer stepNumber, String description) {}
}
