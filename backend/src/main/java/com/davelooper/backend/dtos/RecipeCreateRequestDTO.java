...
public record RecipeCreateRequestDTO(
    ...
    @NotNull(message = "Le nombre de portions est obligatoire.")
        ...
        Integer servings,
    @NotNull(message = "La difficulte est obligatoire.") Integer difficulty,
    @NotNull(message = "Le temps de preparation est obligatoire.") Integer prepTimeMinutes,
    @NotNull(message = "Le temps de cuisson est obligatoire.") Integer cookTimeMinutes,
    @NotNull(message = "L'auteur est obligatoire.") Long authorId,
  ...
  public record RecipeIngredientRequestDTO(
      @NotNull(message = "L'identifiant de l'ingredient est obligatoire.") Long ingredientId,
      @NotNull(message = "La quantite est obligatoire.")
          ...
          BigDecimal quantity,
      @NotNull(message = "L'identifiant de l'unite est obligatoire.") Long unitId) {}

  public record RecipeStepRequestDTO(
      @NotNull(message = "Le numero d'etape est obligatoire.") Integer stepNumber,
      @NotBlank(message = "La description de l'etape est obligatoire.") String description) {}
}
